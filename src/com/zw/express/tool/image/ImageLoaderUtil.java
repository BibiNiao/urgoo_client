...
public class ImageLoaderUtil {
    ...
    public static void initImageLoader(Context context) {
        File cacheDir = StorageUtils.getOwnCacheDirectory(context, "am990/cache/imagediskcache");
...
//                .showStubImage(R.drawable.ic_launcher)    		//在ImageView加载过程中显示图片
             /*  .showImageForEmptyUri(R.drawable.default_useravatar)   //image连接地址为空时
                .showImageOnFail(R.drawable.default_useravatar)  		//image加载失败
    ...
    public static DisplayImageOptions displayImageOptions(int id, int rounded) {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                //  .showStubImage(id)    //在ImageView加载过程中显示图片
                .showImageForEmptyUri(id)  //image连接地址为空时
                .showImageOnFail(id)  //image加载失败
                .imageScaleType(ImageScaleType.EXACTLY)
