...
public class BaseActivity extends SwipeBackActivity implements ActivityInterface, StringRequestCallBack {
    ...
    /**
     * 根据 layout ID 填充视图并返回View对象【默认不依附在父视图上】
     *
     * @param layoutId 布局资源ID
     * @param root     父视图
     * @return
     */
    protected View inflaterViewWithLayoutID(int layoutId, ViewGroup root) {
        return inflaterViewWithLayoutID(layoutId, root, false);
    }

    /**
     * 根据 layout ID 填充视图并返回View对象
     *
     * @param layoutId     布局资源ID
     * @param root         父视图
     * @param attachToRoot 是否将view依附在父视图上
     * @return
     */
    protected View inflaterViewWithLayoutID(int layoutId, ViewGroup root,
        ...
        if (null == mInflater)
            return null;
        return mInflater.inflate(layoutId, root, attachToRoot);
    }
