 ...
 */
public class ActivityesNotAtFragment extends HomeFragment {
    ...
    private void getNotDataList() {
        ProfileManager.getInstance(getActivity()).getNotDataList("", "0", pageNo, this);
    }

    @Override
    protected void onResponseSuccess(EventCode eventCode, JSONObject result) {
        switch (eventCode) {
            case EventCodeGetNotDataList:
                try {
                    if (pageNo == 0) {
                        mList.clear();
                    }
    ...
    public static Fragment getInstance() {
        ActivityesNotAtFragment fragment = new ActivityesNotAtFragment();
        return fragment;
    }
