 ...
 */
public class ActivityesHasAtFragment extends HomeFragment {
    ...
    //1、请等待顾问确认，顾问确认后，请家长在7天内完成咨询费支付
    ...
    private void getOngDataList() {
        ProfileManager.getInstance(getActivity()).getOngDataList("2", "", "2", pageNo, this);
    }
    ...
    public static Fragment getInstance() {
        ActivityesHasAtFragment fragment = new ActivityesHasAtFragment();
        return fragment;
    }
