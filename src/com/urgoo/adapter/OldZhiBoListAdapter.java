 ...
 */
public class OldZhiBoListAdapter extends BaseAdapter {
    private Context mContext;
    private List<Object> mInfoList;
    private int mInfoType = 0;
    private imageLoadBusiness imgservice = new imageLoadBusiness();

    public OldZhiBoListAdapter(Context context, List<Object> mInfoList,
                               int mInfoType) {
            ...
            case 0:
                ...
                if (view == null) {
                    ...
                    view = LayoutInflater.from(mContext).inflate(
                            R.layout.oldzhibolist_item_layout, null);
    ...
    public class CountdownUtil {
        ...
        class CountdownThread extends CountDownTimer {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                counetdownView.setText(DataUtil.formatDuring(Integer.parseInt(millisUntilFinished / 1000 + "")) + "后开始");
            }
