...
public class SystemInformationListAdapter extends BaseAdapter {
    ...
    public SystemInformationListAdapter(Context context, List<Object> mInfoList,
                                        int mInfoType) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        switch (mInfoType) {
            case 0:
                final SystemInformationEntity qb = (SystemInformationEntity) o;
                ViewHolderGNQB vhq = null;
                if (view == null) {
                    vhq = new ViewHolderGNQB();
                    view = LayoutInflater.from(mContext).inflate(
                            R.layout.systeminformation_item, null);
                ...
                vhq.title.setText(qb.getTitleCn());
                vhq.content.setText(qb.getContentCn());
                vhq.txtqbtime .setText(qb.getInsertDatetime());
