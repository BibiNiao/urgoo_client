...
import com.urgoo.message.activities.EaseBaseFragment;
import com.urgoo.message.utils.EaseCommonUtils;
import com.urgoo.message.utils.EaseUserUtils;
import com.urgoo.message.widget.EaseAlertDialog;
import com.urgoo.message.widget.EaseChatExtendMenu;
import com.urgoo.message.widget.EaseChatInputMenu;
import com.urgoo.message.widget.EaseCustomChatRowProvider;
import com.urgoo.message.widget.EaseEmojicon;
import com.urgoo.message.widget.EaseVoiceRecorderView;
...
public class EaseChatFragment extends EaseBaseFragment {
    ...
    //杨德成 20160505 头像昵称处理回调接口
    protected ExpansionInterface anInterface;
    public void  setCallBackInterface( ExpansionInterface _anInterface){
    ...
    //杨德成 2016705 zoom
    public LinearLayout ll_Joining;
    public  LinearLayout ll_Reject;
    public  RelativeLayout rl_Schedule2;

    //杨德成 20160622 视频聊天回调
    public void  myStartVideoCall(){

    }

    public void  myStartVoiceCall(){
    ...
    public RelativeLayout rl_Schedule;

    public  LinearLayout ll_youbao;
    ...
    protected void initView() {
        ...
        //杨德成 20160505
        messageList.setCallBack(anInterface);
        ...
        ll_video=(LinearLayout) getView().findViewById(R.id.ll_video);
        ll_voice=(LinearLayout) getView().findViewById(R.id.ll_voice);

        ll_back=(LinearLayout)getActivity().findViewById(R.id.ll_back);


        tv_message_title=(TextView) getView().findViewById(R.id.tv_message_title);
        tv_rightcontent=(TextView) getView().findViewById(R.id.tv_rightcontent);

        ll_send=(LinearLayout)getActivity().findViewById(R.id.ll_send);
        tv_daojishi=(TextView)getActivity().findViewById(R.id.tv_daojishi);

        tv_time=(TextView)getActivity().findViewById(R.id.tv_time);

        rl_Schedule=(RelativeLayout)getActivity().findViewById(R.id.rl_Schedule);


        ll_Joining=(LinearLayout) getView().findViewById(R.id.ll_Joining);
        ll_Reject=(LinearLayout)getActivity().findViewById(R.id.ll_Reject);
        rl_Schedule2=(RelativeLayout)getView().findViewById(R.id.rl_Schedule2);

        ll_youbao=(LinearLayout)getActivity().findViewById(R.id.ll_youbao);
    ...
    protected void setUpView() {
        ...
        //杨德成 20160505 测试title
        //titleBar.setTitle("123456789");
//        anInterface.SettingChatTitle(titleBar,toChatUsername);
        ...
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onUserAvatarClick(String username) {
                if(chatFragmentListener != null){
                    ...
                    //杨德成 20160513 注释个人资料详情
                    //chatFragmentListener.onAvatarClick(username);

                    //杨德成 20160511 点击聊天头像回调接口方法 以上注释是环信原版个人详情
                    anInterface.SettingChatAvatarClick(username);
                }
            }
