...
import com.urgoo.message.widget.EaseChatRow;
import com.urgoo.message.widget.EaseChatRowFile;
import com.urgoo.message.widget.EaseChatRowImage;
import com.urgoo.message.widget.EaseChatRowText;
import com.urgoo.message.widget.EaseChatRowVoice;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public void setCallBack(ExpansionInterface _anInterface) {

        anInterface = _anInterface;
    }

    public EaseMessageAdapter(Context context, String username, int chatType, ListView listView, ExpansionInterface _anInterface) {
        this.anInterface = _anInterface;
        ...
        //杨德成 20160426
        EaseUserUtils.setCallBack(anInterface);
