 ...
 */
public class HorizontalAdpater extends RecyclerView.Adapter<TimeHolder> implements AbsListView.OnScrollListener {
    ...
    public HorizontalAdpater(Context context, List<RobotOption> robotOptions) {
    ...
    public TimeHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
        // TODO Auto-generated method stub
        View view = mInflater.inflate(R.layout.chatting_horizontal_item, arg0, false);
