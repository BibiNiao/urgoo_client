...
public class CounselorDetail {
    ...
    public void setHabitualResidence(String mHabitualResidence) {
    ...
    public void setAttentionCount(String mAttentionCount) {
    ...
    public void setUserHxCode(String mUserHxCode) {
    ...
    public void setSuccessCase(String mSuccessCase) {
    ...
    public void setCounselorReadCount(String mCounselorReadCount) {
    ...
    public void setServiceMode(String mServiceMode) {
    ...
    public void setAdvanceCount(String mAdvanceCount) {
    ...
    public void setSelfBio(String mSelfBio) {
        selfBio = mSelfBio;
    }
    ...
    public void setLevelEducation(String mLevelEducation) {
    ...
    public void setExtraService(String mExtraService) {
    ...
    public void setEducationBg(String mEducationBg) {
    ...
    public void setRequires(String mRequires) {
        requires = mRequires;
    }
