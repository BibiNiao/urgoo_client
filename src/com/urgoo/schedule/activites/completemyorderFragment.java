 ...
 */
public class completemyorderFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTobeconfirAdapter = new TobeconfirAdapter(getActivity(), mTobeconfir, false);
    ...
    private void getNetDataForupdate() {
        ...
        OkHttpClientManager.postAsyn(ZWConfig.URL_advanceCloseListClient,
