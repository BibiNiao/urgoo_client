 ...
 */
public class NewZhiBoFragment extends HomeFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.newzhibo_layout, container, false);
        initView();
        refreshData();
        return rootView;
    }
    ...
    public static Fragment getInstance() {
        NewZhiBoFragment fragment = new NewZhiBoFragment();
        return fragment;
    }
    ...
    private void getZoomLiveNewest() {
        LiveManager.getInstance(getActivity()).getZoomLiveNewest("", "2", pageNo, pageSize, this);
    }

    @Override
    protected void onResponseSuccess(EventCode eventCode, JSONObject result) {
        switch (eventCode) {
            case EventCodeZoomLiveNewest:
                try {
                    if (pageNo == 0) {
                        mList.clear();
                    }
