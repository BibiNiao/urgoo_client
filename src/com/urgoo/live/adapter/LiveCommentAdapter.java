...
public class LiveCommentAdapter extends UltimateViewAdapter<LiveCommentAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public LiveCommentAdapter(LiveDetailActivity context, List<Comment> comments, String liveId) {
