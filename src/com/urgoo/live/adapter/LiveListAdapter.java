 ...
 */
public class LiveListAdapter extends UltimateViewAdapter<LiveListAdapter.ViewHolder> {
    private Context context;
    private List<Live> lives;
    private OnItemClickListener onItemClickListener;

    public LiveListAdapter(Context context, List<Live> lives) {
    ...
    @Override
    public LiveListAdapter.ViewHolder getViewHolder(View view) {
        return new ViewHolder(view, false);
    }

    @Override
    public LiveListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent) {
